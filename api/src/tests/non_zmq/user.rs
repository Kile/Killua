...
#[test]
fn test_user_edit_invalid_discord_token() {
    // Test user edit with invalid Discord token
    enable_test_mode();
    ...
    // Should return Forbidden due to invalid Discord token
...
#[test]
fn test_user_edit_malformed_auth_header() {
    // Test user edit with malformed authorization header
    enable_test_mode();
    ...
    // Should return Forbidden due to malformed auth header
    assert_eq!(response.status(), Status::Forbidden);
...
#[test]
fn test_user_edit_missing_auth_header() {
    // Test user edit without authorization header
    let client = Client::tracked(rocket()).unwrap();
    ...
    // Should return Forbidden due to missing auth header
    assert_eq!(response.status(), Status::Forbidden);
}
