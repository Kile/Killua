...
class Category(Enum):
    ...
    ACTIONS = {
        ...
        "emoji": {"unicode": "\U0001f465", "normal": ":busts_in_silhouette:"},
    }
    CARDS = {
        "name": "cards",
    ...
    ECONOMY = {
        ...
        "emoji": {"unicode": "\U0001f3c6", "normal": ":trophy:"},
    }
    MODERATION = {
        "name": "moderation",
        "description": "Moderation commands",
        "emoji": {"unicode": "\U0001f6e0", "normal": ":tools:"},
    }
    TODO = {
        "name": "todo",
        "description": "Todo lists on discord to help you be organised",
        "emoji": {"unicode": "\U0001f4dc", "normal": ":scroll:"},
    }
    FUN = {
        "name": "fun",
        "description": "Commands to play around with with friends to pass the time",
        "emoji": {"unicode": "\U0001f921", "normal": ":clown:"},
    }
    OTHER = {
        "name": "other",
    ...
    GAMES = {
        ...
        "emoji": {"unicode": "\U0001f3ae", "normal": ":video_game:"},
    }

    TAGS = {
        "name": "tags",
        "description": "Tags if you want to save some text.",
        "emoji": {"unicode": "\U0001f5c4", "normal": ":file_cabinet:"},
    }
