...
"What was the best thing about how your parents raised you?", "If you could have a fictional superhero for a best friend, who would it be?", "What does your name mean?", "Tell me about your childhood best friend.", "What is the thing you wish you would have known 10 years ago?", "What Netflix show or movie are you marathon-watching?", " What projects are you working on right now that bring you joy?", "What is one thing you should never say at a wedding?", "What do you think are the best traits for a person to have?", "What is something you wish you could do everyday?", "If someone gave you an envelope with your death date inside of it, would you open it?", "What scares you most about your future?", "What three things do you want to be remembered for?", "How would your best friend describe you?", "What is a significant event that has changed you?", "What are three fun facts about yourself?", "Who do you count on the most for help?", "What did you think was the most challenging part of being a kid?", "Have you ever really kept a New Year's resolution?", "How long can you go without checking your phone?", "Which of your family members or friends are you most like?", "How long do you think you'd survive in a zombie apocalypse?", "What's a special habit of yours?", "What's your least favorite color?", "What food describes your personality?", "What do you think is the most unconventional food you've eaten?", "Name an odd talent of yours.", "What's the weirdest gift you've ever received? Given?", "What does the color purple smell like to you?", "Name a fact that you wish you could unlearn.", "What is your most listened to song?", "What's your go-to drink in the morning?", 
"What's the longest word you know?", "If you could meet anyone, alive or dead, who would it be?", "What's a word or phrase that you overuse?", "If you could swap lives with someone, who would it be?", "What's your favorite quote?", "Is cereal soup?", "Make up a conspiracy theory.", "What is something you refuse to eat?", "What's the weirdest food combination you've seen?", "Do you think there's a part of you that you've lost? Why?", "What's your favorite weird habit of your friend/partner?", "What's something you see in your friend/family member that you wish you had more of yourself?", "What part of yourself are you currently trying to work on the most?", "If you could know the absolute truth to one question, what would you ask?", "What's the one 'what if' that keeps you awake at night and why?", "What question are you trying to answer most in your life right now?", "What matters most to you when looking for a partner?", "What do you wish someone had told you before you got your heart broken for the first time?", "What's something weird you find beautiful?", "What moment made you realize what truly matters in life?", "Do you believe that everything happens for a reason?", "What's the most embarrassing thing you've been caught doing because you thought you were alone?", "What part of your relationship/friendship do you think needs the most work?", "Do you ever compare your relationship/friendship to anyone else's? If so, who and why?", "Would you rather be your partner's first love or their last?","Is there a question you've never asked on a first date but have always wanted to?", "What is one thing you want to change about the world?", 
"What is one thing you wish you had learned earlier in life?", "When it comes to dating, what is your biggest turn off?", "What makes you lose trust in someone?", "Do you think I follow my heart or mind more?", "If your life could be told in a single photograph, what would be happening in it?", "Is there a moment you wish you could relive, not to change it, but to experience it again?", "What's one thing in the world you'll never get tired of doing?", "What remains unchanged about you since childhood?", "If you had one wish, but it could only be for someone else, what would it be?", "Are there any personal challenges you're facing that you haven't shared with anyone?", "Is there a feeling you miss?", "What's your biggest fear about your future?", "What have been the best and worst parts about getting older?", "What do you want or wish most for your kids?"]
...
("Know the uncomfortable truth", "Believe a comfortable lie"), ("Donate your body to science", "Donate your organs to people who need them"), ("Have real political power but be relatively poor", "Be ridiculously rich but have no political power (not even bought)"), ("Have a criminal justice system that works and is fair", "Have an administrative branch that is free of corruption"), ("Live iin utopia as a normal person", "Live in distopia but you're the surpreme ruler"), ("Know all the mysteries of the universe", "Know the outcome of every choice you could make"), ("Fight for a cause you believe in, but doubt will succeed", "Fight for a cause that you only partially believe in but have a high chance of your cause succeeding"), ("Eat at the same resturant you usually do", "Eat at a new resturant that just opened"), ("Live in a house that is incredibly unique and beautiful but plain on the inside", "Live in a house that is incredibly unique and beautiful on the inside but plain on the outside"), ("Be half your height", "Be twice your weight")
]

# ACTION IMAGES
with open("hugs.json", "r") as file: # There are so many hug images that they are better stored in a seperate json file
...
# ACTION TEXT
HUG_TEXTS = ["<author> challenges <user> to a hug-off and wins", "<author> hugs <user> like they're squeezing all the bad vibes out", "<author> gives <user> a hug that feels like a warm blanket", "<author> and <user> both reach for the same thing, end up hugging instead", "<author> sees <user> looking down and immediately hugs them", "<author> gives <user> a hug that lasts a little longer than usual", "<author> and <user> share a hug that feels like home", "<author> makes <user> blush by hugging them", "<author> gives <user> a hug. Their face lights up brighter than a star", "<author> makes <user>'s day by giving them a hug", "<author> hugs <user> so strong they can barely breathe", "<author> hugs <user> from behind like a hug-assassine :ninja:", "<user> looked like they needed one of these", f"<author> hugs <user> as strong as they can", "<author> hugs <user> and makes sure to not let go", f"<author> gives <user> the longest hug they have ever seen", f"<author> cuddles <user>", f"<author> uses <user> as a teddybear", f"<author> hugs <user> until all their worries are gone and 5 minutes longer",f"<author> clones themself and together they hug <user>", f"<author> jumps in <user>'s arms", f"<author> gives <user> a bearhug", f"<author> finds a lamp with a Jinn and gets a wish. So they wish to hug <user>", f"<user> asks <author> for motivation and gets a hug","<author> looks at the floor, then up, then at the floor again and finally hugs <user> with passion", "<author> looks deep into <user>'s eyes and then gives them a hug", "<author> could do their homework but instead they decide to hug <user>", "<user> wanted to go get food but <author> wouldn't let go"]
