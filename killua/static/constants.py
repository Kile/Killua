...
("Sleep with 10 blankets", "Sleep with no blanket"), ("Eat the same thing for your entire life", "Drink the same thing for your entire life"), ("Work indoors", "Work outdoors"), ("Never hear again", "Never speak again"), ("Never use a phone again", "Never use a computer again"), ("Have unlimited bacon but no games", "Have games. Unlimited games. But no games")
]
