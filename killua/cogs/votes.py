...
class Vote(commands.Cog):
    ...
    async def on_dbl_vote(self, data):
        ...
        if reward < 100:
            ...
            text = f"Thank you for voting for Killua! Here take {reward} Jenny as a sign of my gratitude. {user.votes%10} votes left from a :sparkles: special :sparkles: reward"
